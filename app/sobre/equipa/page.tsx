    ...
    <section ref={ref} className="pb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {team.map((member, index) => (
          ...
          >
            <div className="relative h-[450px] transform-style-3d transition-all duration-1000 group-hover:rotate-y-180">
              ...
              <div className="absolute inset-0 backface-hidden rotate-y-180 bg-gradient-to-br from-purple-900 to-blue-900 rounded-xl p-6 flex flex-col justify-center">
